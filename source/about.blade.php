...
@section('content')
    ...
    <p> If you wanna claim this domain copyright you have to be 'legal copyright owner' of 'Behind the Classes' Or, you can negotiate with me directly @lrsayed (Telegram) </p>
    <h2>Links:</h2>
